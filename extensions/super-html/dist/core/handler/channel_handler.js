...
class channel_handler {
    async run() {
        ...
        for (let key in inject_channel_adapter) {
            ...
            s_html_content = this._add_script_to_body(s_html_content, `console.log("[WPT]PluginVersion:${config_1.default.PluginVersion}");`);
            let s_out_file_name = "";
            let out_data = null;
            ...
            if (
                ...
                s_channel_name == "tapjoy" ||
                s_channel_name == "adcolony" ||
                s_channel_name == "chartboost" ||
                s_channel_name == "bigo"
              ) {
